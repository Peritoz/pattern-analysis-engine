import {
  extractBondedShortRelationship
} from '../../../src/libs/engine/query_interpreter/ohm_interpreter/semantics/extractBondedShortRelationship';
import {
  extractPathShortRelationship
} from '../../../src/libs/engine/query_interpreter/ohm_interpreter/semantics/extractPathShortRelationship';
...
} from '../../../src/libs/model/input_descriptor/enums/relationship_discriminator.enum';
...
describe('short relationship extraction', () => {
    it.each([
        ...
        ['BONDED_BIDIRECTIONAL', ConnectorDiscriminator.BONDED_LEFT, ConnectorDiscriminator.BONDED_RIGHT],
